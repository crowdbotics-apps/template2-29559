"""template2_29559 URL Configuration
...
admin.site.site_header = "Template2"
admin.site.site_title = "Template2 Admin Portal"
admin.site.index_title = "Template2 Admin"

# swagger
api_info = openapi.Info(
    title="Template2 API",
    default_version="v1",
    description="API documentation for Template2 App",
)
